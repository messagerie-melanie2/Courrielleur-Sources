...
WriteRegStr SHCTX "Software\Classes\courrielleur" "shctxtest" "shctxtestclasses15"
WriteRegStr ${RegKey} "Software\Classes\courrielleur" "regkeytest" "regkeytestclasses15"
