...
MailGlue.prototype = {
  ...
  _onProfileStartup: function MailGlue__onProfileStartup() {
    ...
    if (Services.appinfo.inSafeMode) {
      // 0005739: Redémarrer avec les modules désactivés (afficher mode sans echec devant splash screen)
      Services.ww.openWindow(null, "chrome://messenger/content/safeMode.xul",
                             "_blank", "chrome,centerscreen,modal,alwaysRaised,resizable=no", null);
    }
